    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <main className="container mx-auto py-8 flex-grow">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <p className="mb-4">
            CloudMart is an innovative e-commerce platform developed as part of an intensive cloud computing and artificial intelligence training program. This project serves as a comprehensive learning experience, combining cutting-edge technologies to create a modern, AI-powered online shopping solution.
          </p>
